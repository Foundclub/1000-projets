...
/**
 * POST /api/users/[id]/xp-bonus
 * Attribuer un bonus manuel d'XP à un utilisateur depuis le profil utilisateur
...
export async function POST(
  ...
  try {
    ...
    if (!adminRateLimit(`${key}:user-xp-bonus`, 10, 60_000)) {
    ...
    console.error('Error in POST /api/users/[id]/xp-bonus:', e);
